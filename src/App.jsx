...
const tokenModule = sdk.getTokenModule(
  "0x41E04eC40862c7C7b4AA339A83d950bAB735ebd9"
);
const App = () => {
...
const voteModule = sdk.getVoteModule(
  "0x8FC3F61f2D9160179618b381365dD3B87CdAe7F7",
);
...
if (hasClaimedNFT) {
  return (
    <div className="member-page">
      <h1>BuytheBlock Dao Member Page</h1>
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free BuytheBlock Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => mintNft()}
      >
